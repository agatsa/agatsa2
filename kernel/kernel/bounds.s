...
@ -I /linuxdrive/rowboat-android/kernel/arch/arm/include
@ -I arch/arm/include/generated -I include -I arch/arm/mach-omap2/include
@ -I arch/arm/plat-omap/include
@ -iprefix /linuxdrive/rowboat-android/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/../lib/gcc/arm-eabi/4.6.x-google/
@ -D__USES_INITFINI__ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm
@ -D CC_HAVE_ASM_GOTO -D KBUILD_STR(s)=#s
@ -D KBUILD_BASENAME=KBUILD_STR(bounds)
@ -D KBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem /linuxdrive/rowboat-android/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/../lib/gcc/arm-eabi/4.6.x-google/include
@ -include /linuxdrive/rowboat-android/kernel/include/linux/kconfig.h
...
@ -msoft-float -mfpu=vfp -auxbase-strip kernel/bounds.s -O2 -Wall -Wundef
...
@ -fpeephole -fpeephole2 -fprefetch-loop-arrays -fprofile
